...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("jcwebapi.Models.EmotionCounter", b =>
                {
                    b.Property<int>("JokeId")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("jcwebapi.Models.Joke", b =>
                {
                    b.Property<int>("JokeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("jcwebapi.Models.ResponseStatistic", b =>
                {
                    b.Property<int>("JokeId")
                        .HasColumnType("int")
                        .HasColumnName("JokeId");
            ...
            modelBuilder.Entity("jcwebapi.Models.Tag", b =>
                {
                    b.Property<int>("TagId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("jcwebapi.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JokeTag", b =>
                {
                    b.HasOne("jcwebapi.Models.Joke", null)
                        .WithMany()
                    ...
                    b.HasOne("jcwebapi.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
            ...
            modelBuilder.Entity("jcwebapi.Models.Joke", b =>
                {
                    b.HasOne("jcwebapi.Models.User", "User")
                        .WithMany("Jokes")
